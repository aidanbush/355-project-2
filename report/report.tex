...
To represent our state space we used a multi-dimensional array of 8 x 8 one byte integers.
...
Ideally we would union this with an array of eight 8-bit integers for easier interfacing with the representation.
